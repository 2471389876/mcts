...
for i in range(totalSteps):
    ...
    while True:
        ...
        if done:
            ...
            print(f"第{str(i + 1)}次用户的cost:{1000 - reward},stepCount:{stepCount},Deadline:{envForRun.Deadline},success:{stepCount <= envForRun.Deadline}")
            print()
            print()
            break
...
print("传输成功率：",successTransferCount/totalSteps)
